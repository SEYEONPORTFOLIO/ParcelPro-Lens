...
public class SvrDebugOverrideSettings : MonoBehaviour {
	...
	void Update ()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha5)) { SvrManager.Instance.SetSuspend(true); }
        if (Input.GetKeyDown(KeyCode.Alpha6)) { SvrManager.Instance.SetSuspend(false); }
        ...
        if (Input.GetKeyDown(KeyCode.M)) { SvrOverrideSettings.FoveateArea = Mathf.Clamp(SvrOverrideSettings.FoveateArea + 1f, 0f, 25f); Debug.LogFormat("FoveateArea: {0}", SvrOverrideSettings.FoveateArea); }
        if (Input.GetKeyDown(KeyCode.N)) { SvrOverrideSettings.FoveateArea = Mathf.Clamp(SvrOverrideSettings.FoveateArea - 1f, 0f, 25f); Debug.LogFormat("FoveateArea: {0}", SvrOverrideSettings.FoveateArea); }
