...
public class SvrConfigOptions
{
    ...
    public float? OverlayResolutionScale { get; private set; }
    public bool? FoveationEnabled { get; private set; }
    public int? FoveationLevel { get; private set; }
    public bool? FoveationSubsampled { get; private set; }
    ...
    public bool? DebugHudEnabled { get; private set; }
    public bool? VideoSeeThruEnabled { get; private set; }
    public Vector3? StartPosition { get; private set; }
    public Vector3? StartRotation { get; private set; }
    public Vector3? AugmentPosition { get; private set; }
    public Vector3? AugmentRotation { get; private set; }
    public Vector3? AugmentScale { get; private set; }
    ...
    private string ConfigFilePath
    {
        get
        {
            ...
            {
                optionsFileFullPath = Application.dataPath + "/../config";
            }
            ...
            while (!sr.EndOfStream)
            {
                ...
                switch (tokens[0])
                {
                    ...
                    case "DisableAudio":
                        ...
                        break;
                    case "EyeResolutionScale":
                        EyeResolutionScale = float.Parse(tokens[1]);
                        break;
                    case "OverlayResolutionScale":
                        OverlayResolutionScale = float.Parse(tokens[1]);
                        break;
                    case "FoveationSubsampled":
                        FoveationSubsampled = bool.Parse(tokens[1]);
                        break;
                    case "FoveationLevel":
                        FoveationLevel = int.Parse(tokens[1]);
                        break;
                    ...
                    case "GazeReticleEnabled":
                        ...
                        break;
                    case "DebugHudEnabled":
                        DebugHudEnabled = bool.Parse(tokens[1]);
                        break;
                    case "VideoSeeThruEnabled":
                        VideoSeeThruEnabled = bool.Parse(tokens[1]);
                        break;
                    case "StartPosition":
                        StartPosition = new Vector3(float.Parse(tokens[1]), float.Parse(tokens[2]), float.Parse(tokens[3]));
                        break;
                    case "StartRotation":
                        StartRotation = new Vector3(float.Parse(tokens[1]), float.Parse(tokens[2]), float.Parse(tokens[3]));
                        break;

                    case "AugmentPosition":
                        AugmentPosition = new Vector3(float.Parse(tokens[1]), float.Parse(tokens[2]), float.Parse(tokens[3]));
                        break;
                    case "AugmentRotation":
                        AugmentRotation = new Vector3(float.Parse(tokens[1]), float.Parse(tokens[2]), float.Parse(tokens[3]));
                        break;
                    case "AugmentScale":
                        AugmentScale = new Vector3(float.Parse(tokens[1]), float.Parse(tokens[2]), float.Parse(tokens[3]));
                        break;
