...
{
    public static SvrDebugHud Instance { get; private set; }
    ...
    private void LateUpdate () 
    {
        ...
        //var timestamp = svrManager.HeadPose.timestamp;
        var position = headTransform.localPosition;
        var orientation = headTransform.localRotation;

        //Debug.Log(string.Format("HeadTimestamp: {0}", timestamp));
        //Debug.Log(string.Format("HeadPosition: {0}, {1}, {2}", position.x, position.y, position.z));
        //Debug.Log(string.Format("HeadRotation: {0}, {1}, {2}, {3}", orientation.x, orientation.y, orientation.z, orientation.w));
        ...
        if (_eyesText != null && _eyesText.isActiveAndEnabled)
        {
            ...
            //bool eyeLeftBlink = SvrManager.Instance.EyePose.leftBlink;
            //bool eyeRightBlink = SvrManager.Instance.EyePose.rightBlink;
            //_eyesText.text = string.Format("{0} Eye Blink {1}", eyeLeftBlink, eyeRightBlink);
