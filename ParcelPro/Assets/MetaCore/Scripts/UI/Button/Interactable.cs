...
namespace Pnc.UI.Button
{
    ...
    [AddComponentMenu("MetaCore/Scripts/UI/Button/Interactable")]
    public class Interactable : MonoBehaviour, IMetaCoreTouchHandler
    {
        /// <summary>
        ...
        private InteractableStates states;
        ...
        /// </summary>
        public InteractableStates States
        {
            get => states;
            set
            {
        ...
        public void OnBeforeFocusChange()
        {
            if (!IsEnabled)
            {
                return;
        ...
        {
            Debug.Log($"interactable OnTouchStarted");
            if (!IsEnabled)
            {
                return;
            }
        ...
        {
            Debug.Log($"interactable OnTouchCompleted");
            if (!IsEnabled)
            {
                return;
            }
        ...
        {
            Debug.Log($"interactable IMetaCoreTouchHandler.OnTouchStarted start");
        }
        ...
        {
            Debug.Log($"interactable IMetaCoreTouchHandler.OnTouchCompleted start");
        }
        ...
        {
            Debug.Log($"interactable IMetaCoreTouchHandler.OnTouchUpdated start");
        }
